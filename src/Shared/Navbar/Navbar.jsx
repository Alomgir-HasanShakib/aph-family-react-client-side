              ...
              >
                <li>
                  <Link
                    to="/dashboard"
                    href="#"
                    className="flex items-center  px-4 py-2 text-sm text-green-500 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white "
                  >
                ...
                <li>
                  <Link
                    ...
                    href="#"
                    className="flex items-center px-4 py-2 text-sm text-red-600 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"
                  >
