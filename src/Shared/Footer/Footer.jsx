const Footer = () => {
  return (
    <footer className="bg-gray-800 dark:bg-gray-100 text-gray-50 dark:text-gray-900">
        ...
        <div className="flex flex-col justify-center pt-6 lg:pt-0">
          <div className="flex justify-center space-x-4">
            <a
              ...
              href="#"
              title="Instagram"
              className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-violet-400 dark:bg-violet-600 text-gray-900 dark:text-gray-50"
            >
              <svg
