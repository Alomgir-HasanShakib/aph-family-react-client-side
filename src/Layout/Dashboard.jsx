import { FaBackspace, FaDonate, FaHome, FaUsers } from "react-icons/fa";
import { Link, NavLink, Outlet } from "react-router-dom";
import { GoChecklist } from "react-icons/go";
import { MdCampaign, MdLogout, MdPets } from "react-icons/md";
        ...
        <>
          ...
          <li>
            <NavLink
              ...
              className="flex items-center gap-3 hover:text-blue-800 "
            >
              <MdPets className="text-xl"></MdPets> All Pets
            </NavLink>
          </li>
          <li>
            <NavLink
              ...
              to="/dashboard/alldonators"
              className="flex items-center gap-3 hover:text-blue-800 "
            >
              <FaDonate className="text-xl"></FaDonate> All Donation
            </NavLink>
          </li>
        </>
      ) : (
